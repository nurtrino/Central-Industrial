...
from .goal_based_extractor import EXTRACTOR_SYSTEM
from .prompt_security import untrusted_context_message
...
class DeepResearcher:
    ...
    async def _llm(self, messages: List[Dict], temperature: float = 0.3,
        ...
        from .llm_core import llm_call_async
    ...
    async def _search(self, query: str) -> List[Dict]:
        ...
        try:
            from .search import _get_search_settings
            from .search import _call_provider, _build_provider_chain
